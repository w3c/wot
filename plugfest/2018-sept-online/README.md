...
|:---|:---                 |:---                 |:---                 |:---                 |
|[A](https://lists.w3.org/Archives/Member/member-wot-wg/2018Sep/0019.html)   |  | Intel <BR/> (Panasonic) <BR/> Smart Things | Intel <BR/> (Panasonic) <BR/> Smart Things <br/> => [Minutes](https://www.w3.org/2018/09/26-wot-pf-slot-a-minutes.html)| Intel <BR/> Smart Things |
