...
| Fujitsu   | Local devices: [Rotary beacom light](TDs/Fujitsu/cloud/Fujitsu-RotarybeaconLight.jsonld), [Buzzer](TDs/Fujitsu/cloud/Fujitsu-Buzzer.jsonld), 2 Environment sensors ([A](TDs/Fujitsu/cloud/Fujitsu-WiFiSensor-3C71BF428EF8.jsonld) and [B](TDs/Fujitsu/cloud/Fujitsu-WiFiSensor-3C71BF4253EC.jsonld)) (Temperature, Humidity, Air pressure, Human detection, 3-axis acceleration, Brightness sensors), [Agricuture sensor](TDs/Fujitsu/cloud/Fujitsu-AgriDevice.jsonld) (Temperature, Humidity, Brightness, UV index, CO2), and [Wearable sensor](TDs/Fujitsu/cloud/Fujitsu-CHLOG.jsonld) (Temperature, 3-axis acceleration, Brightness sensor).   |  | ...  | suzuki.takahisa@fujitsu.com, r.matsukura@fujitsu.com |
...
| Fujitsu   | Mozilla WebThings gateway (connecting to Fujitsu's local proxy in Fukuoka) and device ([LED Light](TDs/Fujitsu/cloud/Mozilla-LEDLight.jsonld)) |    | ... | suzuki.takahisa@fujitsu.com, r.matsukura@fujitsu.com |
