# WoT Main Minutes 18 February 2026
...
## Agenda:
 https://www.w3.org/WoT/IG/wiki/Main_WoT_WebConf#18_February_2026
...
### Minutes Review
-> https://pad.w3.org/p/2026-02-11-wot 11 Feb 2026

MK: Will look into minutes taking options again with W3C staff
<MK scanning the minutes>
MK: No objections, minutes approved

### Quick items
MK: any additional items?
-> none
...
MK:  Any holidays/cancellations?
-> none

MK: need to look at schedule, see https://github.com/w3c/wot/blob/main/planning/schedule.md
... need to adjust timeline

### New Charter Discussion
MK: We are looking at a 6 month extensions, right?
... April to October?
... it is the working plan
MK: What is duration of charter?
DR: Depends on charter
... usually not that long
MK: Time depends on scope, I ee
Kaz: Charter period is limited to 2 years
... after 2 years re-chartering is needed
... we need to clarify timeline first (to have good arguments for talk with PLH/Francois Daoust)
DR: Need to work on deliverables for charter
MK: Do we need timeline also?
Kaz: Rough timeline, yes

#### New charter assistant tool 
-> https://www.w3.org/PM/Groups/charter-assistant.html List of known groups
DR: some things are expected now and we should take it into account

#### charter content discussion
##### Issue 1240 
-> https://github.com/w3c/wot/issues/1240

MK: Update to draft charter
EK: My comments are not for this version... not sure if still relevant
Kaz: We can quickly review those 7 items to see if they're still relevant
... if some of them are still relevant, we can assign somebody (see https://github.com/w3c/wot/issues/1240)
... or ask Ege to check
EK: I think we can close issue #1240
MK: Okay, let's close #1240

##### Issue 1241
-> https://github.com/w3c/wot/issues/1241
MK: w.r.t. 1241 I don't know, we should wait for Sebastian
Kaz: When Sebastian will be back we can ask him...
