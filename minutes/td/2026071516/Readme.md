...
**Christian:** Mathematical mapping from Wire and to Wire, for example multiplying a value
...
... but please note that my main point from yesterday's discussion was simply putting those resources on the wot-thing-description repo before the meeting so that we can refer to the resources :)
...
**Michael:** Another point Kaz pointed out yesterday (while Michael was describing his example on TM) was that it would be nicer to have an example of a concrete TD description in addition to the TM
